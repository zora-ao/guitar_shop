...
// This should match your backend to_dict()
...
export const NotificationDropdown = () => {
    ...
    try {
        // 2. Use your existing utility to handle cookies/CSRF automatically
                ...
                <div className="max-h-[350px] overflow-y-auto">
                    ...
                    notifications.map((n) => (
                        ...
                        <div className="flex gap-3">
                            ...
                            <p className="text-[9px] text-stone-300 font-bold uppercase mt-2 tracking-tighter">
                                {n.created_at}
                            </p>
                            </div>
                        </div>
